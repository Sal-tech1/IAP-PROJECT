...
<head>
    ...
    <title><?= esc($pageTitle) ?> | ShopManager</title>
...
<div id="cookieBanner"
    ...
    <div class="container d-flex flex-wrap align-items-center justify-content-between gap-3">
        ...
        <div class="d-flex gap-2">
            <button class="btn btn-warning btn-sm fw-semibold" id="acceptCookies">Accept</button>
...
<!-- ── Navbar ─────────────────────────────────────────────────────────────── -->
<nav class="navbar navbar-expand-lg navbar-dark shadow-sm" style="background: linear-gradient(135deg, #1a5276, #2e86c1);">
    <div class="container">
        <!-- Brand -->
        <a class="navbar-brand fw-bold fs-5" href="index.php">
            <i class="bi bi-shop me-2"></i>ShopManager
        </a>
